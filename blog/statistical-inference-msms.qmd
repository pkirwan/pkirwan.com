...
image: "../images/statistical-inference-banner.png"
categories:
  - Multi-state models
...
::: {.post-navigation}
[← Previous post](multi-state-models.qmd)

[Next post →](causal-inference.qmd)
:::