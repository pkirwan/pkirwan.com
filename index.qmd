...
::: {.about-container}
::: {.about-text}
I'm a postdoctoral research fellow at the [Barcelona Institute for Global Health](https://www.isglobal.org). My current research focuses on the development of statistical microsimulation and forecasting models to project the health effects of changes in Official Development Assistance (ODA) in low- and middle-income countries. My other research interests include the development of statistical models to estimate infectious disease burden, with an application to HIV epidemiology.
...
[Impact of a revised consensus definition of late HIV diagnosis in Europe: A multi-country study](https://doi.org/10.2807/1560-7917.ES.2026.31.32.2500921). *Eurosurveillance*.
:::
